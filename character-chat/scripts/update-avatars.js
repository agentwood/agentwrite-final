...
const realisticCharacters = [
  ...
  'comedic-relief',
  'romantic-partner',
  'cyberpunk-hacker', // Modern tech, leaning realistic
];

// All others are anime-style
const animeCharacters = personas
  .map(p => p.id)
  .filter(id => !realisticCharacters.includes(id));

// Avatar URL mapping
// Using more casual, everyday-looking portraits for realistic characters
// These are carefully selected to match character descriptions and look like "the person next door"
// Using anime-style image services for anime characters
const avatarMap = {
  ...
  // These are selected to look like "the person next door" - authentic and relatable
  // Using different Unsplash photos that are more casual and match descriptions better
  'grumpy-old-man': 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=400&fit=crop&crop=face', // Older man, casual, grumpy - using more casual portrait
  'california-surfer': 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face', // Young casual surfer, relaxed, beach vibes
  'sassy-best-friend': 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop&crop=face', // Casual young woman, friendly, everyday look
  'chef-gordon': 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop&crop=face', // Casual chef, approachable, not too formal
  'ai-tutor': 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop&crop=face', // Casual, friendly tutor, approachable
  'therapy-bot': 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop&crop=face', // Warm, casual woman, empathetic look
  ...
  'cyberpunk-hacker': 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop&crop=face', // Casual tech person, modern, everyday look
  
  // Anime characters - Using anime-style portrait images
  // Using notionists style from Dicebear for more stylized/anime-like appearance
  // This style provides a more anime/cartoon aesthetic similar to Talkie AI
...
console.log(`📊 Realistic: ${realisticCharacters.length}, Anime: ${animeCharacters.length}`);
