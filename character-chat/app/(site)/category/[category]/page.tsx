...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return generateCategoryMetadata(decodedCategory, 'category');
}
          ...
          <section className="bg-gradient-to-br from-indigo-600 via-purple-700 to-pink-600 text-white py-16 px-6">
            <div className="max-w-7xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                {decodedCategory} AI Characters
              </h1>
              <p className="text-xl text-indigo-100 max-w-2xl">
                Discover and chat with {totalCount.toLocaleString()} {decodedCategory.toLowerCase()} AI characters
              </p>
            </div>
          </section>
