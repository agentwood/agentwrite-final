        ...
        <div className="w-full lg:w-[45%] p-8 md:p-12 flex flex-col justify-center relative bg-[#120b18]">
          ...
          <div className="max-w-sm mx-auto w-full relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-white/40 text-sm">Resume your story in the wood.</p>
            </div>
            ...
            <div className="space-y-3">
              <button
                type="button"
                onClick={() => {
                  setSession({ id: 'demo-user', email: 'demo@apple.com', displayName: 'Apple User', planId: 'free' });
                  router.push('/');
                }}
